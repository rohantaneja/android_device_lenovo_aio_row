...
public class Constants {
    ...
    private static final String TOUCHSCREEN_FLASHLIGHT_GESTURE_KEY = "touchscreen_gesture_flashlight";
    private static final String TOUCHSCREEN_DAILER_GESTURE_KEY = "touchscreen_gesture_dailer";
    private static final String TOUCHSCREEN_MESSAGING_GESTURE_KEY = "touchscreen_gesture_messaging";
    private static final String TOUCHSCREEN_MAIL_GESTURE_KEY = "touchscreen_gesture_mail";
    private static final String TOUCHSCREEN_DTWP_KEY = "touchscreen_gesture_dtwp";
    ...
    private static final boolean TOUCHSCREEN_DAILER_DEFAULT = true;
    private static final boolean TOUCHSCREEN_MESSAGING_DEFAULT = true;
    private static final boolean TOUCHSCREEN_MAIL_DEFAULT = true;
    private static final boolean TOUCHSCREEN_DTWP_DEFAULT = true;
    ...
    public static final String[] sGesturePrefKeys = {
        ...
        TOUCHSCREEN_DAILER_GESTURE_KEY,
        TOUCHSCREEN_MESSAGING_GESTURE_KEY,
        TOUCHSCREEN_MAIL_GESTURE_KEY,
        TOUCHSCREEN_DTWP_KEY
    };
    ...
    static {
        ...
        sNodeDefaultMap.put(TOUCHSCREEN_DAILER_GESTURE_KEY, TOUCHSCREEN_DAILER_DEFAULT);
        sNodeDefaultMap.put(TOUCHSCREEN_MESSAGING_GESTURE_KEY, TOUCHSCREEN_MESSAGING_DEFAULT);
        sNodeDefaultMap.put(TOUCHSCREEN_MAIL_GESTURE_KEY, TOUCHSCREEN_MAIL_DEFAULT);
        sNodeDefaultMap.put(TOUCHSCREEN_DTWP_KEY, TOUCHSCREEN_DTWP_DEFAULT);
    }
    ...
    public static void setGestureEnabled(boolean state, String gesture) {
        ...
        switch (gesture) {
            ...
            case TOUCHSCREEN_FLASHLIGHT_GESTURE_KEY:
                cmd = new String[] { "o=" };
                break;
            case TOUCHSCREEN_DAILER_GESTURE_KEY:
                cmd = new String[] { "up=" };
                break;
            case TOUCHSCREEN_MESSAGING_GESTURE_KEY:
                cmd = new String[] { "m=" };
                break;
            case TOUCHSCREEN_MAIL_GESTURE_KEY:
                cmd = new String[] { "e=" };
                break;
             case TOUCHSCREEN_DTWP_KEY:
                cmd = new String[] { "double_click=" };
                break;
            default:
                return;
        }
